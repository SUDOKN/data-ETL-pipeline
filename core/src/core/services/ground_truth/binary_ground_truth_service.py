...
from core.utils.prompt_s3_util import (
...
async def _validate_binary_ground_truth_correction(
    ...
    if linked_manufacturer.subject_unique_id != binary_ground_truth.mfg_etld1:
        raise ValueError(
            f"Manufacturer etld1 mismatch: {linked_manufacturer.subject_unique_id} vs {binary_ground_truth.mfg_etld1}"
        )
