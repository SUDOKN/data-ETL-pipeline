...
class ConceptProposalNode(LLMPhraseProposalNode):
    """The proposal pass of a concept field, serial after the grounding node.
    Its successor is unit screening (a later substep); until the cutover the
    type stays the base's."""
    ...
    def __init__(
        ...
        super().__init__(
            ...
            next_node=next_node,
            phrase_grounding_prompt=phrase_proposal_prompt,
