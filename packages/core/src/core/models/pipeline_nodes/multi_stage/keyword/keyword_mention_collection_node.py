...
class KeywordMentionCollectionNode(LLMPhraseMentionCollectionNode[ExtractionFieldType]):
    """BASE class for the keyword branches' v3 phase 3: narrows the constructor,
    leaves the upstream-map accessors abstract — the app-side leaves
    (pure product / contract product / equipment) point at their own search
    nodes, and the contract leaf shares the pure-product identity."""
