...
def test_the_tripwire_actually_inspects_something():
    ...
    # Tokens outlive nodes so stored ids stay scopable: mention_collection's
    # node went with the location-stage merge (2026-09-03), and the four
    # families Step 2 replaced went at the cutover (2026-09-22).
    retired_without_a_node = {
