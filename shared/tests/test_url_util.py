...
@patch("shared.utils.url_util.requests")
...
@patch("shared.utils.url_util.requests.head")
...
@patch("shared.utils.url_util.requests.Session")
...
def test_get_final_landing_url_edge_case_urls():
    ...
    # URLs with ports
    with patch("shared.utils.url_util.requests.Session") as mock_session_class:
        mock_session = Mock()
        mock_session_class.return_value.__enter__.return_value = mock_session
