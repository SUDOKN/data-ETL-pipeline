...
`{END}`, `{N}`, `20260914T004150`, `{MODEL}` (Sonnet by the user's standing rule),
...
`20260914T004150`. `judge` = `agent:{MODEL} {FIELD} {SUBJECT} part{PART}` (the model
...
- **This run's snippets are WIDER (snippet radius 1, run 20260914T004150):**
