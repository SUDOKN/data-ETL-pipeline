...
from data_etl_app.dependencies.env import SCRAPE_BOT_ENV
...
from llm_providers.models.llm_model import GPT_5_2
...
async def async_main():
    ...
    from infra.utils.aws.queue.gt_extract_queue_util import (
