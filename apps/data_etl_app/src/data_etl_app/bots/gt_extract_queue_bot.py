...
from packages.llm_providers.src.llm_providers.models.llm_model import GPT_4_1, LLM_Model
    ...
    try:
        ...
        if item.email_errand:
            ...
            is_manufacturer_gt = await get_binary_ground_truth(
                manufacturer,
                manufacturer.is_manufacturer.metadata.single_stage.prompt_version_id,
