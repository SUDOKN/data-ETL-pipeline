...
def build_keyword_phrase_trail_entry(
    *,
    ...
    screening_result: dict[int, LLMScreeningResults],
    ...
    return {
        ...
        "screening": screening_result[search_round][phrase],
...
def build_concept_phrase_trail_entry(
    *,
    ...
    return {
        ...
        "screening": screening_result[search_round][phrase_trail.phrase],
