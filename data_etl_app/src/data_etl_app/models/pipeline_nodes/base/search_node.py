...
from data_etl_app.models.pipeline_nodes.foundational.base_llm_extraction_node import (
    LLMExtractionNode,
)
...
class PhraseSearchNode(LLMExtractionNode[LLMExtractedFieldTypeVar, set[str]]):
