...
from data_etl_app.services.ttl_generator_service import generate_triples_for_single_mfg
...
async def replace_manufacturer_in_graph(mfg_etdl1: MfgETLDType) -> None:
    ...
    ontology = await ontology_service.get_ontology(mfg_user_form.ontology_version_id)
    ttl_data = generate_triples_for_single_mfg(ontology, mfg_user_form, False)
